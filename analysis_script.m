...
X_noisy = addTensorNoise(X,40); % requires probabilistic Tensor Toolbox (https://github.com/JesperLH/prob-tensor-toolbox)
...
options_2.sist_threshold = [0.001 3];   
